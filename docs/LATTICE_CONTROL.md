...
- **NOTE:** Debug UE_LOG statements removed from AncientTechDevice.cpp
...
Remaining: placeholder team member, placeholder portal, basic scale HUD
...
- Debug UE_LOG statements removed from AncientTechDevice.cpp
